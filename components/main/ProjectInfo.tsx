  ...
  return (
    <div className="container mx-auto mt-20 md:mt-40 px-4 text-white z-[30]" id='elems'>
      <div className="flex flex-wrap -mx-4 overflow-visible lg:-mx-4 xl:-mx-4">
        ...
        <motion.div className="info-card rounded-md mx-2 first-line:my-4 p-4 w-full overflow-hidden sm:w-full md:mx-0 lg:my-4 lg:px-4 lg:w-1/3 xl:my-4 xl:px-4 xl:w-1/4" whileHover={{scale: 1.05}}>
      ...
      <div className="flex flex-wrap sm:flex-nowrap md:flex-row -mx-4 overflow-visible lg:-mx-4 xl:-mx-4">
        ...
        <motion.div className="info-card rounded-md my-4 mx-2 p-4 w-full overflow-visible sm:w-full md:mx-0 lg:my-4 lg:px-4 lg:w-1/4 xl:my-4 xl:px-4 xl:w-1/4" whileHover={{scale: 1.05}}>
          <p>{minorDescriptionLeft}</p>
        </motion.div>

        {/* Increased width for the middle container */}
        <motion.div className="info-card rounded-md my-4 mx-2 p-4 w-full overflow-visible sm:w-full md:m-4 lg:my-4 lg:p-4 lg:w-1/2 xl:m-4 xl:p-4 xl:w-1/2" whileHover={{scale: 1.05}}>
